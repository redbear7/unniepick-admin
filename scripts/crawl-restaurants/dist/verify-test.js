...
async function test() {
    ...
    for (const tc of testCases) {
        ...
        try {
            const res = await page.goto(`https://pcmap.place.naver.com/restaurant/${tc.placeId}/home`, { waitUntil: 'networkidle', timeout: 15_000 });
            ...
            if (trueClosed)
                console.log(`  진짜 폐업 패턴 감지: "${trueClosed}"`);
        }
        catch (e) {
