...
【절대 규칙 — 반드시 지켜야 함】
① 결과물에 부정적 표현·단점·아쉬운 점을 단 한 글자도 포함하지 마
② 가격·대기·주차·위생 등 불편 요소 언급 금지
③ 별점·리뷰수·방문자수 등 수치 언급 금지
④ 영업시간 언급 금지
⑤ 네이버·카카오 등 외부 플랫폼 이름 언급 금지

【작성 기준】
- 오직 긍정적·매력적인 내용만 담아 방문 욕구를 높이는 문장으로 작성
- 자연스러운 우리말, 과장 없이 주어진 정보 기반으로 작성
- 정보가 부족하면 업체명·카테고리·동네를 조합해 구체적으로 작성
- 한줄요약은 음식 스타일·분위기·대표 메뉴가 느껴지도록 (단순 "○○동 ○○집" 패턴 지양)
- "정보 없음" 같은 표현은 결과물에 절대 쓰지 마

다음 JSON 형식으로만 응답해. 설명 없이 JSON만:
{
  "한줄요약": "40자 이내 핵심 특징 한 문장 (음식 스타일·분위기·대표 메뉴 등 구체적으로)",
  "분위기태그": ["태그1", "태그2", "태그3"],
  "추천메뉴": ["메뉴1", "메뉴2"],
  "방문팁": "40자 이내 실용적인 방문 팁",
