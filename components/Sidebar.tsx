  ...
  return (
    <div
      ...
      className={`flex items-center gap-1 transition ${
        isActive
          ? 'bg-accent/15 border-l-2 border-accent rounded-r-lg'
    ...
    >
      ...
      <Link
        ...
        } ${isActive ? 'text-accent font-semibold' : 'font-medium text-tertiary hover:text-primary'}`}
      >
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 bg-sidebar border-r border-border-main flex flex-col h-full overflow-y-auto">
      {/* 로고 */}
      <div className="border-b border-border-main flex items-center gap-2 px-4 py-4">
        <Link href="/dashboard" className="flex items-center gap-3 flex-1 min-w-0 hover:opacity-80 transition">
      ...
      <nav className="flex-1 px-3 py-4 space-y-5">
        ...
        >
                ...
                {editMode && editingGroupId === group.id ? (
                  <div className="flex items-center gap-1 flex-1">
                    <input
                      ...
                      className="flex-1 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider bg-card border border-accent rounded outline-none text-primary"
                    />
          ...
          <DragOverlay>
            {activeItem ? (
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-card border border-accent/40 shadow-lg text-sm font-medium text-primary opacity-90">
